...
/* Command for C compiler:
   gcc -c  -w  -I/home/esheldon/local/src/nim-0.14.2/lib -o /home/esheldon/git/nimcode/src/images/nimcache/stdlib_math.o /home/esheldon/git/nimcode/src/images/nimcache/stdlib_math.c */
#define NIM_INTBITS 64

#include "nimbase.h"
#include <math.h>
typedef NU8 Floatclass96411;
N_NIMCALL(NI, binom_96202_1009420244)(NI n0, NI k0);
...
N_NIMCALL(NI, fac_96226_1009420244)(NI n0);
N_NIMCALL(Floatclass96411, classify_96419_1009420244)(NF x0);
N_NIMCALL(NIM_BOOL, ispoweroftwo_96425_1009420244)(NI x0);
N_NIMCALL(NI, nextpoweroftwo_96429_1009420244)(NI x0);
N_NIMCALL(NI, countbits32_97019_1009420244)(NI32 n0);
...
{	result0 = (NI)0;
	...
	nimln(27, "math.nim");
	{
		...
		nimln(27, "math.nim");
		TMP145 = mulInt(((NI) 2), k0);
		if (!(n0 < (NI)(TMP145))) goto LA7;
		TMP146 = subInt(n0, k0);
		result0 = binom_96202_1009420244(n0, (NI)(TMP146));
		goto BeforeRet;
	}
	LA7: ;
	nimln(28, "math.nim");
	result0 = n0;
	{
		NI i_96218_1009420244;
		NI res_96222_1009420244;
		i_96218_1009420244 = (NI)0;
		nimln(1875, "system.nim");
		res_96222_1009420244 = ((NI) 2);
		{
			...
			while (1) {
				...
				NI TMP150;
				NI TMP151;
				if (!(res_96222_1009420244 <= k0)) goto LA11;
				nimln(1877, "system.nim");
				i_96218_1009420244 = res_96222_1009420244;
				nimln(30, "math.nim");
				TMP147 = addInt(n0, ((NI) 1));
				TMP148 = subInt((NI)(TMP147), i_96218_1009420244);
				TMP149 = mulInt(result0, (NI)(TMP148));
				TMP150 = divInt((NI)(TMP149), i_96218_1009420244);
				result0 = (NI)(TMP150);
				nimln(1891, "system.nim");
				TMP151 = addInt(res_96222_1009420244, ((NI) 1));
				res_96222_1009420244 = (NI)(TMP151);
			} LA11: ;
		}
	}
	}BeforeRet: ;
...
N_NIMCALL(NI, fac_96226_1009420244)(NI n0) {
	...
	result0 = ((NI) 1);
	{
		NI i_96241_1009420244;
		NI res_96245_1009420244;
		i_96241_1009420244 = (NI)0;
		nimln(1875, "system.nim");
		res_96245_1009420244 = ((NI) 2);
		{
			nimln(1876, "system.nim");
			while (1) {
				NI TMP152;
				NI TMP153;
				if (!(res_96245_1009420244 <= n0)) goto LA3;
				nimln(1877, "system.nim");
				i_96241_1009420244 = res_96245_1009420244;
				nimln(36, "math.nim");
				TMP152 = mulInt(result0, i_96241_1009420244);
				result0 = (NI)(TMP152);
				nimln(1891, "system.nim");
				TMP153 = addInt(res_96245_1009420244, ((NI) 1));
				res_96245_1009420244 = (NI)(TMP153);
			} LA3: ;
		}
	}
	popFrame();
...
N_NIMCALL(Floatclass96411, classify_96419_1009420244)(NF x0) {
	Floatclass96411 result0;
{	result0 = (Floatclass96411)0;
	{
		if (!(x0 == 0.0)) goto LA3;
		{
			if (!(((NF)(1.0000000000000000e+00) / (NF)(x0)) == INF)) goto LA7;
			result0 = ((Floatclass96411) 2);
			goto BeforeRet;
		}
		goto LA5;
		LA7: ;
		{
			result0 = ((Floatclass96411) 3);
			goto BeforeRet;
		}
		LA5: ;
	}
	LA3: ;
	{
		...
		{
			if (!(0.0 < x0)) goto LA16;
			result0 = ((Floatclass96411) 5);
			goto BeforeRet;
		}
		goto LA14;
		LA16: ;
		{
			result0 = ((Floatclass96411) 6);
			goto BeforeRet;
		}
		LA14: ;
	}
...
{	result0 = (NF32)0;
	...
	result0 = ((NF32) (((NF)(((NF) (LOC1))) / (NF)(LOC2))));
	goto BeforeRet;
	}BeforeRet: ;
	return result0;
}
