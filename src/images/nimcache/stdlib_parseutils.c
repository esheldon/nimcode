...
/* Command for C compiler:
   gcc -c  -w  -I/home/esheldon/local/src/nim-0.14.2/lib -o /home/esheldon/git/nimcode/src/images/nimcache/stdlib_parseutils.o /home/esheldon/git/nimcode/src/images/nimcache/stdlib_parseutils.c */
...
N_NIMCALL(NI, rawparseint_103957_1912046442)(NimStringDesc* s0, NI64* b0, NI start0);
...
STRING_LITERAL(TMP368, "overflow", 8);
	...
	nimln(219, "parseutils.nim");
	{
		...
		(*b0) = IL64(0);
		{
			...
			while (1) {
				...
				TMP361 = mulInt64((*b0), IL64(10));
				if ((NU)(i0) > (NU)(s0->Sup.len)) raiseIndexError();
				TMP362 = subInt(((NI) (((NU8)(s0->data[i0])))), ((NI) 48));
				TMP363 = subInt64((NI64)(TMP361), ((NI64) ((NI)(TMP362))));
				(*b0) = (NI64)(TMP363);
				nimln(223, "parseutils.nim");
				TMP364 = addInt(i0, ((NI) 1));
				i0 = (NI)(TMP364);
				{
		...
		TMP366 = mulInt64((*b0), sign0);
		(*b0) = (NI64)(TMP366);
		nimln(226, "parseutils.nim");
		TMP367 = subInt(i0, start0);
		result0 = (NI)(TMP367);
	}
	LA10: ;
	popFrame();
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s0, NI64* number0, NI start0) {
	...
	result0 = rawparseint_103957_1912046442(s0, (&res0), start0);
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s0, NI* number0, NI start0) {
	...
	nimln(247, "parseutils.nim");
	{
		NIM_BOOL LOC3;
		NIM_BOOL LOC5;
		Overflowerror3440* e_104071_1912046442;
		NimStringDesc* LOC9;
		LOC3 = (NIM_BOOL)0;
		LOC3 = NIM_FALSE;
		if (!(LOC3)) goto LA4;
		...
		LA4: ;
		if (!LOC3) goto LA7;
		e_104071_1912046442 = (Overflowerror3440*)0;
		nimln(2514, "system.nim");
		e_104071_1912046442 = (Overflowerror3440*) newObj((&NTI24471), sizeof(Overflowerror3440));
		(*e_104071_1912046442).Sup.Sup.Sup.m_type = (&NTI3440);
		nimln(2515, "system.nim");
		LOC9 = (NimStringDesc*)0;
		LOC9 = (*e_104071_1912046442).Sup.Sup.message; (*e_104071_1912046442).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP368));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		nimln(249, "parseutils.nim");
		raiseException((Exception*)e_104071_1912046442, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
